...
const ExperienceCard = ({
  ...
  return (
    <article className="flex flex-col rounded-lg items-center flex-shrink-0 w-[500px] md:w-[600px] xl:w-[1100px] snap-center bg-[#4d4b4b] p-5 hover:opacity-100 opacity-40 cursor-pointer transistion-opacity duration-200 overflow-hidden mt-8">
      <motion.img
        initial={{
          y: -100,
          opacity: 0,
